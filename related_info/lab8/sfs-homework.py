...
class fs:
    ...
    # DONE
        ...
        if self.inodes[inum].getRefCnt()==0:
            address=self.inodes[inum].addr 
            if address>=0:
                self.dataFree(address)
            self.inodeFree(inum)
    ...
    # DONE
        ...
        if self.data[paddr].getFreeEntries()==0 or self.data[paddr].dirEntryExists(newfile):
            return -1
    ...
    # DONE
        ...
        if ftype=='d':
            ...
            self.data[newdata].addDirEntry('.',pinum)
